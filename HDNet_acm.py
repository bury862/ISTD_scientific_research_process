...
class HDNet(nn.Module):
    def __init__(self, input_channels, block=ResNet):
        ...
        self.acm3 = AsymBiChaFuseReduce(param_channels[4], param_channels[3], out_channels=param_channels[3])
        self.acm2 = AsymBiChaFuseReduce(param_channels[3], param_channels[2], out_channels=param_channels[2])
        self.acm1 = AsymBiChaFuseReduce(param_channels[2], param_channels[1], out_channels=param_channels[1])
        self.acm0 = AsymBiChaFuseReduce(param_channels[1], param_channels[0], out_channels=param_channels[0])
        ##################################
